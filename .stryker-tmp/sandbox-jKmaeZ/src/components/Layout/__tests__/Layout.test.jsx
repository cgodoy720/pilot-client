...
describe('Layout Component', () => {
  ...
  describe('Mobile Navigation', () => {
    ...
    it('should show admin links in mobile navbar for admin users', () => {
      ...
      // Find all Admin Dashboard links and verify at least one exists
      ...
      // Also check for Assessment Grades (may appear in both mobile and desktop navbars)
      const assessmentGradesLinks = screen.getAllByRole('link', { name: /Assessment Grades/i });
      expect(assessmentGradesLinks.length).toBeGreaterThan(0);
    });
  });
