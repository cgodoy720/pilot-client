...
const Layout = ({
  ...
  if (stryMutAct_9fa48("0")) {
    ...
    return <div className="flex h-screen w-full bg-background">
      ...
      : isNavbarHovered ? stryMutAct_9fa48("145") ? "" : (stryCov_9fa48("145"), "w-[250px]") // Desktop expanded width
      : stryMutAct_9fa48("146") ? "" : (stryCov_9fa48("146"), "w-[50px]") // Desktop collapsed width
        ...
        <div className="relative">
            ...
            {stryMutAct_9fa48("168") ? isMobileNavbarOpen || <>
                ...
                <div className="absolute top-[53px] left-0 w-[386px] h-[calc(100vh-53px)] bg-[#1E1E1E] z-[70]">
                  {/* Dashboard */}
                  <Link to="/dashboard" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                  ...
                  {/* Learning */}
                  <Link to="/learning" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/learning' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                  ...
                  {/* AI Chat */}
                  <Link to="/gpt" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/gpt' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                  ...
                  {/* Calendar */}
                  <Link to="/calendar" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/calendar' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <line x1="16" y1="2" x2="16" y2="6" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  ...
                  {/* Progress */}
                  <Link to="/stats" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/stats' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <polyline points="22,12 18,12 15,21 9,3 6,12 2,12" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                  ...
                  {/* Assessment */}
                  <Link to="/assessment" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/assessment' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.89 22 5.99 22H18C19.1 22 20 21.1 20 20V8L14 2Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <polyline points="14,2 14,8 20,8" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  ...
                  {(user?.role === 'admin' || user?.role === 'staff') && <>
                      {/* Admin Dashboard */}
                      <Link to="/admin-dashboard" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/admin-dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      ...
                      {/* Assessment Grades */}
                      <Link to="/admin/assessment-grades" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/admin/assessment-grades' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      ...
                      {/* Admissions */}
                      <Link to="/admissions-dashboard" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/admissions-dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      ...
                      {/* Content Generation */}
                      <Link to="/content" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/content' || location.pathname.startsWith('/content') ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      ...
                      {/* AI Prompts */}
                      <Link to="/admin-prompts" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/admin-prompts' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                  ...
                  {/* Account */}
                  <Link to="/account" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center border-b border-gray-700", location.pathname === '/account' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                ...
                <div className="absolute top-[53px] left-0 w-[386px] h-[calc(100vh-53px)] bg-[#1E1E1E] z-[70]">
                  ...
                  {/* Learning */}
                  <Link to="/learning" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("176") ? "" : (stryCov_9fa48("176"), "relative h-[53px] flex items-center border-b border-gray-700"), (stryMutAct_9fa48("179") ? location.pathname !== '/learning' : stryMutAct_9fa48("178") ? false : stryMutAct_9fa48("177") ? true : (stryCov_9fa48("177", "178", "179"), location.pathname === (stryMutAct_9fa48("180") ? "" : (stryCov_9fa48("180"), '/learning')))) ? stryMutAct_9fa48("181") ? "" : (stryCov_9fa48("181"), "bg-[#4242EA]") : stryMutAct_9fa48("182") ? "" : (stryCov_9fa48("182"), "hover:bg-white/10"))}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <path d="M2 3H8C9.1 3 10 3.9 10 5V19C10 20.1 9.1 21 8 21H2C1.45 21 1 20.55 1 20V4C1 3.45 1.45 3 2 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M22 3H16C14.9 3 14 3.9 14 5V19C14 20.1 14.9 21 16 21H22C22.55 21 23 20.55 23 20V4C23 3.45 22.55 3 22 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  ...
                  {/* AI Chat */}
                  <Link to="/gpt" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("183") ? "" : (stryCov_9fa48("183"), "relative h-[53px] flex items-center border-b border-gray-700"), (stryMutAct_9fa48("186") ? location.pathname !== '/gpt' : stryMutAct_9fa48("185") ? false : stryMutAct_9fa48("184") ? true : (stryCov_9fa48("184", "185", "186"), location.pathname === (stryMutAct_9fa48("187") ? "" : (stryCov_9fa48("187"), '/gpt')))) ? stryMutAct_9fa48("188") ? "" : (stryCov_9fa48("188"), "bg-[#4242EA]") : stryMutAct_9fa48("189") ? "" : (stryCov_9fa48("189"), "hover:bg-white/10"))}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                  ...
                  {/* Progress */}
                  <Link to="/stats" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("197") ? "" : (stryCov_9fa48("197"), "relative h-[53px] flex items-center border-b border-gray-700"), (stryMutAct_9fa48("200") ? location.pathname !== '/stats' : stryMutAct_9fa48("199") ? false : stryMutAct_9fa48("198") ? true : (stryCov_9fa48("198", "199", "200"), location.pathname === (stryMutAct_9fa48("201") ? "" : (stryCov_9fa48("201"), '/stats')))) ? stryMutAct_9fa48("202") ? "" : (stryCov_9fa48("202"), "bg-[#4242EA]") : stryMutAct_9fa48("203") ? "" : (stryCov_9fa48("203"), "hover:bg-white/10"))}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                        <polyline points="22,12 18,12 15,21 9,3 6,12 2,12" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                  ...
                  {stryMutAct_9fa48("213") ? user?.role === 'admin' || user?.role === 'staff' || <>
                      ...
                      {/* Admissions */}
                      <Link to="/admissions-dashboard" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("238") ? "" : (stryCov_9fa48("238"), "relative h-[53px] flex items-center border-b border-gray-700"), (stryMutAct_9fa48("241") ? location.pathname !== '/admissions-dashboard' : stryMutAct_9fa48("240") ? false : stryMutAct_9fa48("239") ? true : (stryCov_9fa48("239", "240", "241"), location.pathname === (stryMutAct_9fa48("242") ? "" : (stryCov_9fa48("242"), '/admissions-dashboard')))) ? stryMutAct_9fa48("243") ? "" : (stryCov_9fa48("243"), "bg-[#4242EA]") : stryMutAct_9fa48("244") ? "" : (stryCov_9fa48("244"), "hover:bg-white/10"))}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                          <Users className="h-4 w-4 text-[#E3E3E3]" />
                        </div>
                        <div className="flex items-center ml-[60px]">
                      ...
                      {/* AI Prompts */}
                      <Link to="/admin-prompts" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("256") ? "" : (stryCov_9fa48("256"), "relative h-[53px] flex items-center border-b border-gray-700"), (stryMutAct_9fa48("259") ? location.pathname !== '/admin-prompts' : stryMutAct_9fa48("258") ? false : stryMutAct_9fa48("257") ? true : (stryCov_9fa48("257", "258", "259"), location.pathname === (stryMutAct_9fa48("260") ? "" : (stryCov_9fa48("260"), '/admin-prompts')))) ? stryMutAct_9fa48("261") ? "" : (stryCov_9fa48("261"), "bg-[#4242EA]") : stryMutAct_9fa48("262") ? "" : (stryCov_9fa48("262"), "hover:bg-white/10"))}>
                        <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                          <Brain className="h-4 w-4 text-[#E3E3E3]" />
                        </div>
                        <div className="flex items-center ml-[60px]">
                  ...
                  {/* Account */}
                  <Link to="/account" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("301") ? "" : (stryCov_9fa48("301"), "relative h-[53px] flex items-center border-b border-gray-700"), (stryMutAct_9fa48("304") ? location.pathname !== '/account' : stryMutAct_9fa48("303") ? false : stryMutAct_9fa48("302") ? true : (stryCov_9fa48("302", "303", "304"), location.pathname === (stryMutAct_9fa48("305") ? "" : (stryCov_9fa48("305"), '/account')))) ? stryMutAct_9fa48("306") ? "" : (stryCov_9fa48("306"), "bg-[#4242EA]") : stryMutAct_9fa48("307") ? "" : (stryCov_9fa48("307"), "hover:bg-white/10"))}>
                    <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 14 18" fill="none">
                        <path d="M7 9C9.20914 9 11 7.20914 11 5C11 2.79086 9.20914 1 7 1C4.79086 1 3 2.79086 3 5C3 7.20914 4.79086 9 7 9Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1 17V15C1 13.9391 1.42143 12.9217 2.17157 12.1716C2.92172 11.4214 3.93913 11 5 11H9C10.0609 11 11.0783 11.4214 11.8284 12.1716C12.5786 12.9217 13 13.9391 13 15V17" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        {isMobile ? stryMutAct_9fa48("321") ? isMobileNavbarOpen || <Link to="/learning" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/learning' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="M2 3H8C9.1 3 10 3.9 10 5V19C10 20.1 9.1 21 8 21H2C1.45 21 1 20.55 1 20V4C1 3.45 1.45 3 2 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M22 3H16C14.9 3 14 3.9 14 5V19C14 20.1 14.9 21 16 21H22C22.55 21 23 20.55 23 20V4C23 3.45 22.55 3 22 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            </Link> : stryMutAct_9fa48("320") ? false : stryMutAct_9fa48("319") ? true : (stryCov_9fa48("319", "320", "321"), isMobileNavbarOpen && <Link to="/learning" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("322") ? "" : (stryCov_9fa48("322"), "relative h-[53px] flex items-center"), (stryMutAct_9fa48("325") ? location.pathname !== '/learning' : stryMutAct_9fa48("324") ? false : stryMutAct_9fa48("323") ? true : (stryCov_9fa48("323", "324", "325"), location.pathname === (stryMutAct_9fa48("326") ? "" : (stryCov_9fa48("326"), '/learning')))) ? stryMutAct_9fa48("327") ? "" : (stryCov_9fa48("327"), "bg-[#4242EA]") : stryMutAct_9fa48("328") ? "" : (stryCov_9fa48("328"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="M2 3H8C9.1 3 10 3.9 10 5V19C10 20.1 9.1 21 8 21H2C1.45 21 1 20.55 1 20V4C1 3.45 1.45 3 2 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M22 3H16C14.9 3 14 3.9 14 5V19C14 20.1 14.9 21 16 21H22C22.55 21 23 20.55 23 20V4C23 3.45 22.55 3 22 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            </Link>) : <Link to="/learning" className={cn(stryMutAct_9fa48("329") ? "" : (stryCov_9fa48("329"), "relative h-[44px] flex items-center"), (stryMutAct_9fa48("332") ? location.pathname !== '/learning' : stryMutAct_9fa48("331") ? false : stryMutAct_9fa48("330") ? true : (stryCov_9fa48("330", "331", "332"), location.pathname === (stryMutAct_9fa48("333") ? "" : (stryCov_9fa48("333"), '/learning')))) ? stryMutAct_9fa48("334") ? "" : (stryCov_9fa48("334"), "bg-[#4242EA]") : stryMutAct_9fa48("335") ? "" : (stryCov_9fa48("335"), "hover:bg-white/10"))}>
            <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <path d="M2 3H8C9.1 3 10 3.9 10 5V19C10 20.1 9.1 21 8 21H2C1.45 21 1 20.55 1 20V4C1 3.45 1.45 3 2 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M22 3H16C14.9 3 14 3.9 14 5V19C14 20.1 14.9 21 16 21H22C22.55 21 23 20.55 23 20V4C23 3.45 22.55 3 22 3Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        {isMobile ? stryMutAct_9fa48("341") ? isMobileNavbarOpen || <Link to="/gpt" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/gpt' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
        ...
        {isMobile ? stryMutAct_9fa48("361") ? isMobileNavbarOpen || <Link to="/calendar" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/calendar' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <rect x="3" y="4" width="18" height="18" rx="2" ry="2" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <line x1="16" y1="2" x2="16" y2="6" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        {isMobile ? stryMutAct_9fa48("381") ? isMobileNavbarOpen || <Link to="/stats" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/stats' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <polyline points="22,12 18,12 15,21 9,3 6,12 2,12" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ...
            </Link> : stryMutAct_9fa48("380") ? false : stryMutAct_9fa48("379") ? true : (stryCov_9fa48("379", "380", "381"), isMobileNavbarOpen && <Link to="/stats" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("382") ? "" : (stryCov_9fa48("382"), "relative h-[53px] flex items-center"), (stryMutAct_9fa48("385") ? location.pathname !== '/stats' : stryMutAct_9fa48("384") ? false : stryMutAct_9fa48("383") ? true : (stryCov_9fa48("383", "384", "385"), location.pathname === (stryMutAct_9fa48("386") ? "" : (stryCov_9fa48("386"), '/stats')))) ? stryMutAct_9fa48("387") ? "" : (stryCov_9fa48("387"), "bg-[#4242EA]") : stryMutAct_9fa48("388") ? "" : (stryCov_9fa48("388"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <polyline points="22,12 18,12 15,21 9,3 6,12 2,12" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
        ...
        {isMobile ? stryMutAct_9fa48("401") ? isMobileNavbarOpen || <Link to="/assessment" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/assessment' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.89 22 5.99 22H18C19.1 22 20 21.1 20 20V8L14 2Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <polyline points="14,2 14,8 20,8" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        {isMobile ? stryMutAct_9fa48("421") ? (user?.role === 'admin' || user?.role === 'staff') && isMobileNavbarOpen || <Link to="/admin-dashboard" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/admin-dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Settings className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
            ...
            </Link> : stryMutAct_9fa48("420") ? false : stryMutAct_9fa48("419") ? true : (stryCov_9fa48("419", "420", "421"), (stryMutAct_9fa48("423") ? user?.role === 'admin' || user?.role === 'staff' || isMobileNavbarOpen : stryMutAct_9fa48("422") ? true : (stryCov_9fa48("422", "423"), (stryMutAct_9fa48("425") ? user?.role === 'admin' && user?.role === 'staff' : stryMutAct_9fa48("424") ? true : (stryCov_9fa48("424", "425"), (stryMutAct_9fa48("427") ? user?.role !== 'admin' : stryMutAct_9fa48("426") ? false : (stryCov_9fa48("426", "427"), (stryMutAct_9fa48("428") ? user.role : (stryCov_9fa48("428"), user?.role)) === (stryMutAct_9fa48("429") ? "" : (stryCov_9fa48("429"), 'admin')))) || (stryMutAct_9fa48("431") ? user?.role !== 'staff' : stryMutAct_9fa48("430") ? false : (stryCov_9fa48("430", "431"), (stryMutAct_9fa48("432") ? user.role : (stryCov_9fa48("432"), user?.role)) === (stryMutAct_9fa48("433") ? "" : (stryCov_9fa48("433"), 'staff')))))) && isMobileNavbarOpen)) && <Link to="/admin-dashboard" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("434") ? "" : (stryCov_9fa48("434"), "relative h-[53px] flex items-center"), (stryMutAct_9fa48("437") ? location.pathname !== '/admin-dashboard' : stryMutAct_9fa48("436") ? false : stryMutAct_9fa48("435") ? true : (stryCov_9fa48("435", "436", "437"), location.pathname === (stryMutAct_9fa48("438") ? "" : (stryCov_9fa48("438"), '/admin-dashboard')))) ? stryMutAct_9fa48("439") ? "" : (stryCov_9fa48("439"), "bg-[#4242EA]") : stryMutAct_9fa48("440") ? "" : (stryCov_9fa48("440"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Settings className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
            ...
            </Link>) : stryMutAct_9fa48("443") ? user?.role === 'admin' || user?.role === 'staff' || <Link to="/admin-dashboard" className={cn("relative h-[44px] flex items-center", location.pathname === '/admin-dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Settings className="h-4 w-4 text-[#E3E3E3]" />
              </div>
            ...
            </Link> : stryMutAct_9fa48("442") ? false : stryMutAct_9fa48("441") ? true : (stryCov_9fa48("441", "442", "443"), (stryMutAct_9fa48("445") ? user?.role === 'admin' && user?.role === 'staff' : stryMutAct_9fa48("444") ? true : (stryCov_9fa48("444", "445"), (stryMutAct_9fa48("447") ? user?.role !== 'admin' : stryMutAct_9fa48("446") ? false : (stryCov_9fa48("446", "447"), (stryMutAct_9fa48("448") ? user.role : (stryCov_9fa48("448"), user?.role)) === (stryMutAct_9fa48("449") ? "" : (stryCov_9fa48("449"), 'admin')))) || (stryMutAct_9fa48("451") ? user?.role !== 'staff' : stryMutAct_9fa48("450") ? false : (stryCov_9fa48("450", "451"), (stryMutAct_9fa48("452") ? user.role : (stryCov_9fa48("452"), user?.role)) === (stryMutAct_9fa48("453") ? "" : (stryCov_9fa48("453"), 'staff')))))) && <Link to="/admin-dashboard" className={cn(stryMutAct_9fa48("454") ? "" : (stryCov_9fa48("454"), "relative h-[44px] flex items-center"), (stryMutAct_9fa48("457") ? location.pathname !== '/admin-dashboard' : stryMutAct_9fa48("456") ? false : stryMutAct_9fa48("455") ? true : (stryCov_9fa48("455", "456", "457"), location.pathname === (stryMutAct_9fa48("458") ? "" : (stryCov_9fa48("458"), '/admin-dashboard')))) ? stryMutAct_9fa48("459") ? "" : (stryCov_9fa48("459"), "bg-[#4242EA]") : stryMutAct_9fa48("460") ? "" : (stryCov_9fa48("460"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Settings className="h-4 w-4 text-[#E3E3E3]" />
              </div>
        ...
        {isMobile ? stryMutAct_9fa48("466") ? (user?.role === 'admin' || user?.role === 'staff') && isMobileNavbarOpen || <Link to="/admin/assessment-grades" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/admin/assessment-grades' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Award className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
            ...
            </Link> : stryMutAct_9fa48("465") ? false : stryMutAct_9fa48("464") ? true : (stryCov_9fa48("464", "465", "466"), (stryMutAct_9fa48("468") ? user?.role === 'admin' || user?.role === 'staff' || isMobileNavbarOpen : stryMutAct_9fa48("467") ? true : (stryCov_9fa48("467", "468"), (stryMutAct_9fa48("470") ? user?.role === 'admin' && user?.role === 'staff' : stryMutAct_9fa48("469") ? true : (stryCov_9fa48("469", "470"), (stryMutAct_9fa48("472") ? user?.role !== 'admin' : stryMutAct_9fa48("471") ? false : (stryCov_9fa48("471", "472"), (stryMutAct_9fa48("473") ? user.role : (stryCov_9fa48("473"), user?.role)) === (stryMutAct_9fa48("474") ? "" : (stryCov_9fa48("474"), 'admin')))) || (stryMutAct_9fa48("476") ? user?.role !== 'staff' : stryMutAct_9fa48("475") ? false : (stryCov_9fa48("475", "476"), (stryMutAct_9fa48("477") ? user.role : (stryCov_9fa48("477"), user?.role)) === (stryMutAct_9fa48("478") ? "" : (stryCov_9fa48("478"), 'staff')))))) && isMobileNavbarOpen)) && <Link to="/admin/assessment-grades" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("479") ? "" : (stryCov_9fa48("479"), "relative h-[53px] flex items-center"), (stryMutAct_9fa48("482") ? location.pathname !== '/admin/assessment-grades' : stryMutAct_9fa48("481") ? false : stryMutAct_9fa48("480") ? true : (stryCov_9fa48("480", "481", "482"), location.pathname === (stryMutAct_9fa48("483") ? "" : (stryCov_9fa48("483"), '/admin/assessment-grades')))) ? stryMutAct_9fa48("484") ? "" : (stryCov_9fa48("484"), "bg-[#4242EA]") : stryMutAct_9fa48("485") ? "" : (stryCov_9fa48("485"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Award className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
            ...
            </Link>) : stryMutAct_9fa48("488") ? user?.role === 'admin' || user?.role === 'staff' || <Link to="/admin/assessment-grades" className={cn("relative h-[44px] flex items-center", location.pathname === '/admin/assessment-grades' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Award className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className={cn("flex items-center transition-all duration-300 ease-in-out", isNavbarHovered ? "ml-[50px] opacity-100" : "ml-[50px] opacity-0 w-0 overflow-hidden")}>
            ...
            </Link> : stryMutAct_9fa48("487") ? false : stryMutAct_9fa48("486") ? true : (stryCov_9fa48("486", "487", "488"), (stryMutAct_9fa48("490") ? user?.role === 'admin' && user?.role === 'staff' : stryMutAct_9fa48("489") ? true : (stryCov_9fa48("489", "490"), (stryMutAct_9fa48("492") ? user?.role !== 'admin' : stryMutAct_9fa48("491") ? false : (stryCov_9fa48("491", "492"), (stryMutAct_9fa48("493") ? user.role : (stryCov_9fa48("493"), user?.role)) === (stryMutAct_9fa48("494") ? "" : (stryCov_9fa48("494"), 'admin')))) || (stryMutAct_9fa48("496") ? user?.role !== 'staff' : stryMutAct_9fa48("495") ? false : (stryCov_9fa48("495", "496"), (stryMutAct_9fa48("497") ? user.role : (stryCov_9fa48("497"), user?.role)) === (stryMutAct_9fa48("498") ? "" : (stryCov_9fa48("498"), 'staff')))))) && <Link to="/admin/assessment-grades" className={cn(stryMutAct_9fa48("499") ? "" : (stryCov_9fa48("499"), "relative h-[44px] flex items-center"), (stryMutAct_9fa48("502") ? location.pathname !== '/admin/assessment-grades' : stryMutAct_9fa48("501") ? false : stryMutAct_9fa48("500") ? true : (stryCov_9fa48("500", "501", "502"), location.pathname === (stryMutAct_9fa48("503") ? "" : (stryCov_9fa48("503"), '/admin/assessment-grades')))) ? stryMutAct_9fa48("504") ? "" : (stryCov_9fa48("504"), "bg-[#4242EA]") : stryMutAct_9fa48("505") ? "" : (stryCov_9fa48("505"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Award className="h-4 w-4 text-[#E3E3E3]" />
              </div>
        ...
        {isMobile ? stryMutAct_9fa48("511") ? (user?.role === 'admin' || user?.role === 'staff') && isMobileNavbarOpen || <Link to="/admissions-dashboard" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/admissions-dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Users className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
            ...
            </Link>) : stryMutAct_9fa48("533") ? user?.role === 'admin' || user?.role === 'staff' || <Link to="/admissions-dashboard" className={cn("relative h-[44px] flex items-center", location.pathname === '/admissions-dashboard' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Users className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className={cn("flex items-center transition-all duration-300 ease-in-out", isNavbarHovered ? "ml-[50px] opacity-100" : "ml-[50px] opacity-0 w-0 overflow-hidden")}>
        ...
        {isMobile ? stryMutAct_9fa48("556") ? (user?.role === 'admin' || user?.role === 'staff') && isMobileNavbarOpen || <Link to="/content" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/content' || location.pathname.startsWith('/content') ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Bug className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
            ...
            </Link>) : stryMutAct_9fa48("582") ? user?.role === 'admin' || user?.role === 'staff' || <Link to="/content" className={cn("relative h-[44px] flex items-center", location.pathname === '/content' || location.pathname.startsWith('/content') ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Bug className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className={cn("flex items-center transition-all duration-300 ease-in-out", isNavbarHovered ? "ml-[50px] opacity-100" : "ml-[50px] opacity-0 w-0 overflow-hidden")}>
        ...
        {isMobile ? stryMutAct_9fa48("609") ? (user?.role === 'admin' || user?.role === 'staff') && isMobileNavbarOpen || <Link to="/admin-prompts" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/admin-prompts' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <Brain className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className="flex items-center ml-[60px]">
              ...
              </Link>) : stryMutAct_9fa48("631") ? user?.role === 'admin' || user?.role === 'staff' || <Link to="/admin-prompts" className={cn("relative h-[44px] flex items-center", location.pathname === '/admin-prompts' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
                <Brain className="h-4 w-4 text-[#E3E3E3]" />
              </div>
              <div className={cn("flex items-center transition-all duration-300 ease-in-out", isNavbarHovered ? "ml-[50px] opacity-100" : "ml-[50px] opacity-0 w-0 overflow-hidden")}>
        ...
        {isMobile ? stryMutAct_9fa48("735") ? isMobileNavbarOpen || <Link to="/account" onClick={closeMobileNavbar} className={cn("relative h-[53px] flex items-center", location.pathname === '/account' ? "bg-[#4242EA]" : "hover:bg-white/10")}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 14 18" fill="none">
                  <path d="M7 9C9.20914 9 11 7.20914 11 5C11 2.79086 9.20914 1 7 1C4.79086 1 3 2.79086 3 5C3 7.20914 4.79086 9 7 9Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M1 17V15C1 13.9391 1.42143 12.9217 2.17157 12.1716C2.92172 11.4214 3.93913 11 5 11H9C10.0609 11 11.0783 11.4214 11.8284 12.1716C12.5786 12.9217 13 13.9391 13 15V17" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              ...
              </Link> : stryMutAct_9fa48("734") ? false : stryMutAct_9fa48("733") ? true : (stryCov_9fa48("733", "734", "735"), isMobileNavbarOpen && <Link to="/account" onClick={closeMobileNavbar} className={cn(stryMutAct_9fa48("736") ? "" : (stryCov_9fa48("736"), "relative h-[53px] flex items-center"), (stryMutAct_9fa48("739") ? location.pathname !== '/account' : stryMutAct_9fa48("738") ? false : stryMutAct_9fa48("737") ? true : (stryCov_9fa48("737", "738", "739"), location.pathname === (stryMutAct_9fa48("740") ? "" : (stryCov_9fa48("740"), '/account')))) ? stryMutAct_9fa48("741") ? "" : (stryCov_9fa48("741"), "bg-[#4242EA]") : stryMutAct_9fa48("742") ? "" : (stryCov_9fa48("742"), "hover:bg-white/10"))}>
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 14 18" fill="none">
                  <path d="M7 9C9.20914 9 11 7.20914 11 5C11 2.79086 9.20914 1 7 1C4.79086 1 3 2.79086 3 5C3 7.20914 4.79086 9 7 9Z" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M1 17V15C1 13.9391 1.42143 12.9217 2.17157 12.1716C2.92172 11.4214 3.93913 11 5 11H9C10.0609 11 11.0783 11.4214 11.8284 12.1716C12.5786 12.9217 13 13.9391 13 15V17" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        {isMobile ? stryMutAct_9fa48("755") ? isMobileNavbarOpen || <button onClick={handleLogout} className="relative h-[53px] flex items-center hover:bg-white/10 text-[#E3E3E3] w-full">
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 16 18" fill="none" transform="rotate(90)">
                  <path d="M6 17L2 13L6 9" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2 13H14" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            </button> : stryMutAct_9fa48("754") ? false : stryMutAct_9fa48("753") ? true : (stryCov_9fa48("753", "754", "755"), isMobileNavbarOpen && <button onClick={handleLogout} className="relative h-[53px] flex items-center hover:bg-white/10 text-[#E3E3E3] w-full">
              <div className="absolute left-0 top-0 w-[60px] h-[53px] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 16 18" fill="none" transform="rotate(90)">
                  <path d="M6 17L2 13L6 9" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2 13H14" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            </button>) : <button onClick={handleLogout} className="relative h-[44px] flex items-center hover:bg-white/10 text-[#E3E3E3] w-full">
            <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 16 18" fill="none" transform="rotate(90)">
                <path d="M6 17L2 13L6 9" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M2 13H14" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
