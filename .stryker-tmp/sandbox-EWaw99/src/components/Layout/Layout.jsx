...
const Layout = ({
  ...
  if (stryMutAct_9fa48("0")) {
    ...
    return <div className="flex h-screen w-full bg-background">
      ...
      : stryMutAct_9fa48("146") ? "" : (stryCov_9fa48("146"), "w-[50px]") // Desktop collapsed width
      )} onMouseEnter={stryMutAct_9fa48("147") ? () => undefined : (stryCov_9fa48("147"), () => stryMutAct_9fa48("150") ? !isMobile || setIsNavbarHovered(true) : stryMutAct_9fa48("149") ? false : stryMutAct_9fa48("148") ? true : (stryCov_9fa48("148", "149", "150"), (stryMutAct_9fa48("151") ? isMobile : (stryCov_9fa48("151"), !isMobile)) && setIsNavbarHovered(stryMutAct_9fa48("152") ? false : (stryCov_9fa48("152"), true))))} onMouseLeave={stryMutAct_9fa48("153") ? () => undefined : (stryCov_9fa48("153"), () => stryMutAct_9fa48("156") ? !isMobile || setIsNavbarHovered(false) : stryMutAct_9fa48("155") ? false : stryMutAct_9fa48("154") ? true : (stryCov_9fa48("154", "155", "156"), (stryMutAct_9fa48("157") ? isMobile : (stryCov_9fa48("157"), !isMobile)) && setIsNavbarHovered(stryMutAct_9fa48("158") ? true : (stryCov_9fa48("158"), false))))} data-testid="navbar">
        {/* Mobile Menu Button / Current Page Indicator */}
        {isMobile ?
        // Mobile: Show current page icon as menu button
        <div className="relative">
            <button onClick={toggleMobileNavbar} className={cn(stryMutAct_9fa48("159") ? "" : (stryCov_9fa48("159"), "w-[60px] h-[53px] flex items-center justify-center"), isMobileNavbarOpen ? stryMutAct_9fa48("160") ? "" : (stryCov_9fa48("160"), "bg-[#4242EA]") : stryMutAct_9fa48("161") ? "" : (stryCov_9fa48("161"), "bg-[#4242EA] hover:bg-blue-600"))} data-testid="mobile-menu-button">
            ...
            {stryMutAct_9fa48("168") ? isMobileNavbarOpen || <>
                ...
                <div className="absolute top-[53px] left-0 w-[386px] h-[calc(100vh-53px)] bg-[#1E1E1E] z-[70]" data-testid="mobile-navbar">
                  {/* Dashboard */}
                ...
                {/* Mobile Close Button */}
                <button onClick={closeMobileNavbar} className="absolute right-3 top-3 text-white hover:text-gray-300 z-[80]" data-testid="mobile-close-button">
                  <X className="h-6 w-6" />
                </button>
        ...
        {isMobile ? stryMutAct_9fa48("755") ? isMobileNavbarOpen || <button onClick={handleLogout} className="relative h-[53px] flex items-center hover:bg-gray-800 text-[#E3E3E3] w-full">
            ...
            </button>) : <button onClick={handleLogout} className="relative h-[44px] flex items-center hover:bg-gray-800 text-[#E3E3E3] w-full" data-testid="logout-button">
            <div className="absolute left-0 top-0 w-[50px] h-[44px] flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 16 18" fill="none" transform="rotate(90)">
                <path d="M6 17L2 13L6 9" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M2 13H14" stroke="#E3E3E3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
