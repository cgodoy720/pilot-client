# Pursuit Financial Forecasting & Bedrock — Project Context

Archived from the original root CLAUDE.md. Reference material for project overview, prototype scope, and conventions.
