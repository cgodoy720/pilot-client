...
- **Phase 3 (reporting/Slack):** Custom reports, Slack-driven pipeline updates, unified Automation Review queue. Specs: `custom-reports.md`, `slack-data-entry-and-review.md`; also `PRD.md` dashboards and `home-page-spec.md` §3.4 (Automation Review).

Empty phase-1/2/3 files were removed; this README is the index.
