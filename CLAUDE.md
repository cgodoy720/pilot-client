...
**Admin-only**: `/admin-prompts`, `/admin/organization-management`, `/admin/permissions`, `/admin/weekly-reports`, `/admin/platform-analytics`, `/admin/demo-cohort-refresh`, `/admin/coach-runs`
