...
export const getCachedCohortPerformance = async (token, options = {}) => {
  ...
  const cacheKey = cacheService.generateKey('/api/admin/dashboard/cohort-performance', { period });
...
export const getCachedTodaysAttendance = async (token, options = {}) => {
  ...
  const cacheKey = cacheService.generateKey('/api/admin/dashboard/today');
...
export const invalidateTodaysAttendanceCache = () => {
  cacheService.clearPattern('/api/admin/dashboard/today');
