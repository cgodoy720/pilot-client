...
export const getTodaysAttendanceOverview = async (token) => {
  try {
    const response = await fetch(`${API_URL}/api/admin/attendance/dashboard/today`, {
      method: 'GET',
      headers: {
...
export const getCohortPerformance = async (token, options = {}) => {
  ...
  return retryWithBackoff(
    async () => {
      const url = new URL(`${API_URL}/api/admin/attendance/dashboard/cohort-performance`);
      if (period) {
...
export const getDailyReport = async (date, token) => {
  try {
    const response = await fetch(`${API_URL}/api/admin/attendance/reports/daily/${date}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
...
export const getWeeklyReport = async (startDate, token) => {
  try {
    const response = await fetch(`${API_URL}/api/admin/attendance/reports/weekly/${startDate}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
...
export const getMonthlyReport = async (month, token) => {
  try {
    const response = await fetch(`${API_URL}/api/admin/attendance/reports/monthly/${month}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
...
export const getBuildersRiskAssessment = async (token) => {
  try {
    const response = await fetch(`${API_URL}/api/admin/attendance/builders/risk-assessment`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
...
export const exportAttendanceCSV = async (startDate, endDate, cohort = 'all') => {
  ...
  return retryWithBackoff(
    async () => {
      ...
      const response = await fetch(`${API_URL}/api/admin/attendance/export/csv?${params}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
...
export const getCsvExportHistory = async (params = {}) => {
  ...
  return retryWithBackoff(
    async () => {
      ...
      const response = await fetch(`${API_URL}/api/admin/attendance/export/history?${queryParams}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
...
export const getAllCsvExportHistory = async (params = {}) => {
  ...
  return retryWithBackoff(
    async () => {
      ...
      const response = await fetch(`${API_URL}/api/admin/attendance/export/history/all?${queryParams}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
...
export const getCsvExportStatistics = async (params = {}) => {
  ...
  return retryWithBackoff(
    async () => {
      ...
      const response = await fetch(`${API_URL}/api/admin/attendance/export/statistics?${queryParams}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
